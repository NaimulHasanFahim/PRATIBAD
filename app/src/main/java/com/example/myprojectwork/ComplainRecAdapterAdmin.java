...
public class ComplainRecAdapterAdmin  extends RecyclerView.Adapter<ComplainRecAdapterAdmin.ViewHolder> {
    ...
    public ComplainRecAdapterAdmin(Context mContext, ArrayList<Complaint> mUsers){
        this.mUsers=mUsers;
    ...
    @NonNull
    @Override
    public ComplainRecAdapterAdmin.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.complaint_single_layout,parent,false);
        return new ComplainRecAdapterAdmin.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(myContext, AdminComplainLoadActivity.class);
