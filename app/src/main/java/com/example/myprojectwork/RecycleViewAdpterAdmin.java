...
public class RecycleViewAdpterAdmin extends RecyclerView.Adapter<RecycleViewAdpterAdmin.ViewHolder> {
    private Context mContext;
    private ArrayList<User> mUsers;

    public RecycleViewAdpterAdmin(Context mContext,ArrayList<User> mUsers){
        this.mUsers=mUsers;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecycleViewAdpterAdmin.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(myContext, MessageActivityAdmin.class);
