...
public class Admin_Police_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__police_);
        ...
        mytoolpolice.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Admin_Police_Activity.this,Admin_MainActivity.class ));
                finish();
            }
        });
    ...
    private  void call_1(){
        ...
        police1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ActivityCompat.checkSelfPermission(Admin_Police_Activity.this, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED){
                    startActivity(alert_intent);

                }
                else {
                    ActivityCompat.requestPermissions(Admin_Police_Activity.this,new String[] {Manifest.permission.CALL_PHONE}, MY_CALL_PERMISSION_CODE);
                }
            }
