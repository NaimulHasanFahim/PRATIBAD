...
public class EditProfile_Activity extends AppCompatActivity {
    ...
    private EditText phone,address,userName;
    private Button updatepro;
    private Uri myimagruri;
    private String proimagelink="default";
    ...
    private void UploadData() {
        ...
        RootRef.child("Users").child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String adressuser = address.getText().toString().trim();

                User user = new User(currentUserId,name,proimagelink,adressuser,phoneuser);
       ...
       // logd("Inside Retrive User");
        ...
        RootRef.child("Users").child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                proimagelink = retrieveProfileImage;
    ...
    private void InitializeFields() {
        ...
        userName =(EditText) findViewById(R.id.editnametxt);
        ...
        updatepro =(Button) findViewById(R.id.buttonupdate);
    }
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            logd(""+downloadUri);
                            RootRef.child("Users").child(currentUserId).child("imageURL").setValue(downloadUri.toString());
